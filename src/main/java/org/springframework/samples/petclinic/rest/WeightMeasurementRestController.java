...
public class WeightMeasurementRestController {
	...
	public ResponseEntity<WeightMeasurement> getWeightMeasurement(@PathVariable("weightMeasurementId") int weightMeasurementId){
	...
	public ResponseEntity<Collection<WeightMeasurement>> getWeightMeasurementByAthleteId(@PathVariable("athleteId") int athleteId){
	...
	public ResponseEntity<WeightMeasurement> addWeightMeasurement(@RequestBody @Valid WeightMeasurement weightMeasurement, @PathVariable("username") String username, BindingResult bindingResult, UriComponentsBuilder ucBuilder){
		...
		headers.setLocation(ucBuilder.path("/api/weightMeasurements/{id}").buildAndExpand(weightMeasurement.getId()).toUri());
	...
	public ResponseEntity<WeightMeasurement> updateWeightMeasurement(@PathVariable("weightMeasurementId") int weightMeasurementId, @RequestBody @Valid WeightMeasurement weightMeasurement, BindingResult bindingResult){
		BindingErrorsResponse errors = new BindingErrorsResponse();
		HttpHeaders headers = new HttpHeaders();
		if(bindingResult.hasErrors() || (weightMeasurement == null)){
			errors.addAllErrors(bindingResult);
